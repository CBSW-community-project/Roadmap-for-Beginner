export const frontendCollection = {
	name: "FrontEnd",
	areas: [
		{
			name: "HTML",
			...
			skills: [
				...
				},
				{
					...
					description: {
						...
						links: [
							["Add Reactstrap Components In ReactJS", "https://www.c-sharpcorner.com/article/reactstrap-in-reactjs/"]
						]
					}
				},
				{
				...
				},
				{
					...
					description: {
						...
						links: [
							...
							["Bootstrap Official Documentation", "https://getbootstrap.com/docs/5.2/getting-started/introduction/"]
						]
					}
				},
			]
